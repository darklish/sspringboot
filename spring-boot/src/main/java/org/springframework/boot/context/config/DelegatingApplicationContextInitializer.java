...
public class DelegatingApplicationContextInitializer implements
    ...
    private static final Log logger = LogFactory.getLog(DelegatingApplicationContextInitializer.class);
	...
	public void initialize(ConfigurableApplicationContext context) {
        logger.info("初始化 DelegatingApplicationContextInitializer, 读取context.initializer.classes配置的初始类");
