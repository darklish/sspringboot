...
public class ConfigurationWarningsApplicationContextInitializer
	...
	public void initialize(ConfigurableApplicationContext context) {
        logger.info("初始化 ConfigurationWarningsApplicationContextInitializer, 添加ConfigurationWarningsPostProcessor");
	...
	protected static final class ConfigurationWarningsPostProcessor
		...
		public ConfigurationWarningsPostProcessor(Check[] checks) {
		    logger.info("内部类ConfigurationWarningsPostProcessor初始化,作用:把在注册BeanDefinition实例过程中产生的告警信息传给Check接口的实例进行处理");
			this.checks = checks;
		}
